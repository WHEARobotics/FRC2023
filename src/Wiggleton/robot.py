...
class Myrobot(wpilib.TimedRobot):
    ...
    def robotInit(self):
        ...
        self.ARM_GEAR_RATIO = 51 #to get the gear ratio, we had 48 teeth from the sprocket and divided it from the output sahft which is 12, then we multiplied that from the gear ratio which is 12.75
        ...
        self.wristmotor.configMotionCruiseVelocity(self.targetPos / 15, self.kTimeoutMs)
        self.wristmotor.configMotionAcceleration(self.targetPos / 30, self.kTimeoutMs)
