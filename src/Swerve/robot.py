...
class Myrobot(wpilib.TimedRobot):
    ...
    def robotInit(self):
        ...
        # server = '127.0.0.1'  # Use this if simulation
        # # server = '10.38.81.2' # Use proper IP if on RoboRio
        # NetworkTables.initialize(server='127.0.0.1')
        # self.smart_dashboard = NetworkTables.getTable("SmartDashboard")
        # # Call this once, so that the dashboard has the initial values
        # self.tick = 0.0
    ...
    def autonomousPeriodic(self):
        ...
        # if self.autoState == 1:
        #     self.drivemotor.set(ctre._ctre.ControlMode.PercentOutput, 0.5)
        #     self.autostate = 2
    ...
    def teleopPeriodic(self):
        ...
        if AButton: #cube INTAKE
            ...
            self.claw.set(ctre._ctre.ControlMode.PercentOutput, -5.0) 
        else:
            self.claw.set(ctre._ctre.ControlMode.PercentOutput, 0.0) 
